    ...
    <Navbar/>
      ...
      <h1 className='font-bold text-center text-4xl'>ITask - Manage your todos at one place</h1>
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 mx-2 hover:bg-violet-950
          disabled:bg-violet-700 p-2 py-1 text-sm font-bold text-white rounded-md'>Save</button>
          </div>
        </div>
        <input className='my-4' onChange={toggleFinished} type="checkbox" checked={showFinished} /> showFinished
          ...
          <div className="todos">
            ...
            return (showFinished || !item.isCompleted) && <div key={todo.id} className="todo flex my-3 justify-between ">
